...
import { ButtonUserAction } from './index';
...
export default class publicProfileOffline extends React.Component {
    ...
    componentDidMount() {
        ...
        Request.publicUserOffline((users) => {
            if (users !== null) {
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >MY <span className="w3-hide-small"
                                        >WEBSITE</span> PROFILE</span>
                                    </div>
                                </div>
                                ...
                                <div className="w3-content w3-container w3-padding-64" id="about">
                                    ...
                                    <p className="w3-wide"
                                    ><i className="fa fa-camera"></i>Photography</p>
                                    ...
                                    <p className="w3-wide"
                                    ><i className="fa fa-laptop"></i>Web Design</p>
                                    <div className="w3-light-grey">
                                        <div
                                            className="w3-container w3-padding-small w3-dark-grey w3-center"
                                            style={{ width: '85%' }}
                                    ...
                                    <p className="w3-wide"
                                    ><i className="fa fa-photo"></i>Photoshop</p>
                                    <div className="w3-light-grey">
                                        <div
                                            className="w3-container w3-padding-small w3-dark-grey w3-center"
                                            style={{ width: '75%' }}
